...
<template>
  <div class="about-page">
    <section class="page-hero"><div class="hero-content" style="position:relative;z-index:1;"><span class="breadcrumb">首页 / 关于我们</span><h1>关于我们</h1><p>专注电风扇与取暖器</p></div></section>
