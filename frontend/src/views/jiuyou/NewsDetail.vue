...
<template>
  <div class="detail-page" v-if="article">
    <section class="page-hero"><div class="hero-content" style="position:relative;z-index:1;"><span class="breadcrumb">首页 / 新闻中心</span><h1>{{ article.title }}</h1><span class="hero-date">{{ article.date }}</span></div></section>
