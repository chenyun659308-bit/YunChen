...
<template>
  <div class="detail-page" v-if="article">
    <section class="page-hero"><div class="hero-bg"></div><div class="hero-content"><span class="breadcrumb">首页 / 新闻中心</span><h1>{{ article.title }}</h1><span class="hero-date">{{ article.date }}</span></div></section>
...
.page-hero { position: relative; height: 35vh; min-height: 280px; overflow: hidden; display: flex; align-items: center; justify-content: center; }
